...
function error_middleware(error, request, response, next){
    ...
    //logger.info(_execution_id, error.name, error.message);
...
app.post(config.app_authentication_path, function(request, response, next){ execute_middleware(request, response, authentication.authenticate, next); });

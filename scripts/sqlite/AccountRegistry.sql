--
-- File generated with SQLiteStudio v3.2.1 on Thu Jan 17 15:29:24 2019
--
...
-- Table: Group
CREATE TABLE "Group" (GroupId TEXT PRIMARY KEY, GroupName TEXT NOT NULL UNIQUE, CreationUser TEXT NOT NULL, CreationDate TEXT NOT NULL, LastModifiedUser TEXT NOT NULL, LastModifiedgDate TEXT NOT NULL);

-- Table: GroupMember
CREATE TABLE GroupMember (
    GroupId           TEXT NOT NULL REFERENCES [Group] (GroupId) ,
    UserId            TEXT NOT NULL REFERENCES Account (UserId),
    CreationUser      TEXT NOT NULL,
    CreationDate      TEXT NOT NULL,
    LastModifiedUser  TEXT NOT NULL,
    LastModifiedgDate TEXT NOT NULL,
